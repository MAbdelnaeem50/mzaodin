    ...
    <div dir="rtl" class="w-full mx-auto p-4 rounded-lg">
      ...
      <div class="relative w-full max-w-md mx-auto mb-4">
        ...
        <div class="absolute top-4 left-4">
          <span class="font-bold bg-green-500 text-white px-3 py-1 sm:px-4 sm:py-1 rounded-3xl text-sm sm:text-sm">
            جاري
          </span>
        </div>
      ...
      <div class="flex justify-center space-x-2 rtl:space-x-reverse mb-4">
        ...
        <div v-for="(value, unit) in countdown" :key="unit" class="flex flex-col items-center">
          <div class="bg-green-500 text-white text-lg sm:text-lg p-2 sm:p-2 rounded-lg shadow-lg text-center lg:w-14 w-20 h-11">
            {{ value }}
          </div>
      ...
      <div class="bg-blue-500 text-white text-lg sm:text-lg p-2 sm:p-2 rounded-lg shadow-lg text-center lg:w-14 w-20 h-11">
            50%
          </div>
          <span class="text-sm mt-1">نسبة انطلاق المزاد</span>
        </div>
    </div>
    </div>
  </template>
